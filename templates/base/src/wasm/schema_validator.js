/* @ts-self-types="./schema_validator.d.ts" */
 ...
 * @returns {string}
 */
export function get_validation_errors(data_json, schema_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ret = wasm.get_validation_errors(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
 ...
 * @returns {boolean}
 */
export function validate_field(value_json, field_type) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.validate_field(ptr0, len0, ptr1, len1);
    return ret !== 0;
}
 ...
 * @returns {boolean}
 */
export function validate_schema(data_json, schema_json) {
    const ptr0 = passStringToWasm0(data_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(schema_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.validate_schema(ptr0, len0, ptr1, len1);
    return ret !== 0;
}
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./schema_validator_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('schema_validator_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
