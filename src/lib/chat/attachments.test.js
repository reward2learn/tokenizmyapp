...
import { attachmentDataUrl, classifyAttachment, describeAttachmentForPrompt, isChatAttachment, isSpreadsheet, } from './attachments';
...
describe('attachmentDataUrl', () => {
    ...
    it('returns null without base64', () => {
        const attachment = { name: 'a.png', mimeType: 'image/png', size: 3, kind: 'image' };
