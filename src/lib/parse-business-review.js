...
export function parseBusinessReviewParts(markdown) {
    ...
    if (headerIndices.length === 0) {
        throw new Error('No "## Part <label>: <title>" or "## Part <label> — <title>" sections found in Business Review MD');
    }
    const parts = [];
...
export function isPartHeader(line) {
