...
import { isChatSessionAction } from '@/lib/chat/session-tools';
const initialState = {
    messages: [],
    streamingText: '',
    isStreaming: false,
...
export const sendStreamingMessage = createAsyncThunk('chatStream/sendStreamingMessage', async ({ message, history, attachments }, { dispatch, rejectWithValue }) => {
...
export const chatStreamSlice = createSlice({
    ...
    reducers: {
        ...
        queueSessionAction(state, action) {
...
export const { addMessage, appendToken, clearMessages, clearPendingSessionActions, queueSessionAction, resetStream, setMessages, setStreamError, setStreaming, } = chatStreamSlice.actions;
