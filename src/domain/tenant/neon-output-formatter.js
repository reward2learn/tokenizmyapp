 ...
 */
function deriveUnpooledHost(pooledHost) {
 ...
 *   ...
 */
export function formatNeonConnectionStrings(db, slug) {
 ...
 */
export function formatNeonOutput(db, slug) {
 ...
 */
export function formatNeonEnvBlock(db, slug) {
    const formatted = formatNeonConnectionStrings(db, slug);
    const lines = [];
