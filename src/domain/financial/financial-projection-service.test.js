...
import { FinancialProjectionService, groupProjectionsByTypeScenario, resolveDbPeriod, resolveForecastPeriod, scenarioKeyToQuery, SCENARIO_MAP, } from '@/domain/financial/financial-projection-service';
describe('FinancialProjectionService scenario resolution', () => {
    ...
    describe('groupProjectionsByTypeScenario', () => {
        it('groups rows by data_type:scenario composite key', () => {
            const rows = [
                { period: '2026-06', dataType: 'actual', scenario: 'actual' },
                { period: '2029-06', dataType: 'forecast', scenario: 'realistic' },
                { period: '2027-06', dataType: 'forecast', scenario: 'conservative' },
                { period: '2026-07', dataType: 'actual', scenario: 'actual' },
            ];
