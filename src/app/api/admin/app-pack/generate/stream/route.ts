...
/**
 * GET /api/admin/app-pack/generate/stream?runId=wrun_...
 *
 * SSE stream of app-pack generation progress chunks, forwarded verbatim from
 * the workflow's writable stream:
 *
 *   data: {"step":"generating","message":"Generated \"HR\" ...","pct":45}
 */
