...
export async function PUT(request) {
    try {
        ...
        try {
            ...
            return NextResponse.json({ success: false, error: msg, step: 'updateAppSettings' }, { status: 500 });
        }
        return jsonOk({
            tenantSlug: settings.tenantSlug,
            tenantDisplayName: settings.tenantDisplayName,
        ...
        return NextResponse.json({ success: false, error: msg, step: 'outer' }, { status: 500 });
    }
}
