 ...
 */
const LEGACY_CODE_TO_SUB = Object.fromEntries(PERSONS.map((p) => {
...
export async function PUT(request) {
    ...
    const { code, name, isPlatformAdmin } = (body ?? {});
