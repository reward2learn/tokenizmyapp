...
function validate(value, storedValue) {
...
async function exchangeCodeForToken(code, codeVerifier, requestOrigin) {
...
export async function GET(request) {
    try {
        ...
        return NextResponse.redirect(new URL(`/admin?vercel=error&reason=${encodeURIComponent(msg)}`, request.url));
    }
}
