...
import { SettingsPageFooter } from '@/components/settings/settings-panel';
...
export default function SettingsPage() {
  return (
    <AuthGate requiredTier="google" fallback={<SignInPanelGate requiredTier="google" />}>
      <Box sx={{ p: { xs: 2, md: 3 }, maxWidth: 1200, mx: 'auto', minHeight: '100%', display: 'flex', flexDirection: 'column' }}>
