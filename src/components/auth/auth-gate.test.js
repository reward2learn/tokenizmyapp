...
function renderWithTier(tier, bootstrapped = true) {
    ...
    return render(_jsx(Provider, { store: store, children: _jsx(AuthGate, { requiredTier: "google", fallback: _jsx("p", { children: "Google sign-in required" }), children: _jsx("p", { children: "Protected content" }) }) }));
}
describe('AuthGate', () => {
