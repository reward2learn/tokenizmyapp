/**
 * Red Ruby Business Review — seed fixture only.
 *
 * Used by Upload & Seed on tenant apps (not tokenizmyapp). The platform factory
 * app must never write this corpus — see seed-knowledge-corpus.ts.
 */
...
export const PRIORITY_ACTIONS = {
  ...
  P0_THIS_WEEK: [
    'CEO: set floor price (liabilities + capital contribution)',
    'Operations: implement operational cost freeze to IDR ~900M/month floor',
    'Entertainment: convert highest-cost talent contracts to residencies',
    'Operations: audit ghost promoter fee payouts vs. POS attributed guests',
    'Finance: begin supplier aging report for top-5 vendors by volume and debt',
  ],
  P1_THIS_MONTH: [
    'Finance: complete inter-company reconciliation (Red Ruby ↔ StarWORLD flow)',
    'Compliance: confirm PT share transferability + permit transfer rules with Denpasar office',
    'Operations: catalogue full FF&E inventory with market resale estimates',
    'Entertainment: cut entertainment spend to ≤IDR 180M/month via residency roster',
    'Operations + Compliance: negotiate extended supplier terms for sell-side cooperation window',
  ],
  P2_THIS_QUARTER: [
    'Finance: model worst-case liquidity stress test (cash runway under 3 scenarios)',
    'Compliance: survey all supplier contract exit/novation terms',
    'All: assemble sell-side clean books package (P&L, balance sheet, license transfer docs)',
    'CEO: engage with identified 3–5 buyer leads',
    'Finance + CEO: finalize floor price before any buyer discussions begin',
  ],
  P0_IMMEDIATE: [
    'CEO: set floor price (liabilities + capital contribution)',
    'Operations: implement operational cost freeze to IDR ~900M/month floor',
